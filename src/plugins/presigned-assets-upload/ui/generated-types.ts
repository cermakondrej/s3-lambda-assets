...
export type CreateExistingAssetInput = {
...
export type Mutation = {
  ...
  createExistingAssets: Array<CreateAssetResult>;
};
...
export type MutationCreateExistingAssetsArgs = {
  input: Array<CreateExistingAssetInput>;
};
...
export namespace CreatePresignedPost {
  export type Variables = CreatePresignedPostMutationVariables;
  export type Mutation = CreatePresignedPostMutation;
  export type CreatePresignedPost = (NonNullable<CreatePresignedPostMutation['createPresignedPost']>);
}

export namespace CreateExistingAssets {
  export type Variables = CreateExistingAssetsMutationVariables;
  export type Mutation = CreateExistingAssetsMutation;
  export type CreateExistingAssets = NonNullable<(NonNullable<CreateExistingAssetsMutation['createExistingAssets']>)[number]>;
  export type AssetInlineFragment = (DiscriminateUnion<NonNullable<(NonNullable<CreateExistingAssetsMutation['createExistingAssets']>)[number]>, { __typename?: 'Asset' }>);
  export type Tags = NonNullable<(NonNullable<(DiscriminateUnion<NonNullable<(NonNullable<CreateExistingAssetsMutation['createExistingAssets']>)[number]>, { __typename?: 'Asset' }>)['tags']>)[number]>;
  export type ErrorResultInlineFragment = (DiscriminateUnion<NonNullable<(NonNullable<CreateExistingAssetsMutation['createExistingAssets']>)[number]>, { __typename?: 'ErrorResult' }>);
}
...
export type CreatePresignedPostMutation = (
  ...
  & { createPresignedPost: (
    { __typename?: 'PresignedPost' }
    & Pick<PresignedPost, 'url' | 'fields'>
  ) }
);

export type CreateExistingAssetsMutationVariables = Exact<{
  input: Array<CreateExistingAssetInput> | CreateExistingAssetInput;
}>;


export type CreateExistingAssetsMutation = (
  { __typename?: 'Mutation' }
  & { createExistingAssets: Array<(
    { __typename?: 'Asset' }
    & { tags: Array<(
      { __typename?: 'Tag' }
      & TagFragment
